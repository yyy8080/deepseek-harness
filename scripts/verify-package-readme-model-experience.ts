...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/connector/connector-host': { kind: 'indirect', reason: 'The target-side host answers filesystem and process operations; the connector-backed providers and dsh-connector own every rendered effect.' },
  'packages/connector/connector-tcp': { kind: 'indirect', reason: 'The transport carries already-typed operations; the connector-backed providers and dsh-connector own every rendered effect.' },
  'packages/connector/fs-connector': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-tool-fs.' },
  'packages/connector/subprocess-connector': { kind: 'indirect', reason: 'The remote spawn backend delegates model rendering to consumer seams such as the bash executor family.' },

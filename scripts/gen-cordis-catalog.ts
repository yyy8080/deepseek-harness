...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  InstanceCreateRequest: 'instance.md',
  InstanceEndpoint: 'instance.md',
  InstanceId: 'instance.md',
  InstanceProvider: 'instance.md',
  InstanceView: 'instance.md',

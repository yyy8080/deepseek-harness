...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  InstalledPluginVersion: 'marketplace.md',
  PluginCatalogProvider: 'marketplace.md',
  PluginId: 'marketplace.md',
  PluginListing: 'marketplace.md',
  PluginRelease: 'marketplace.md',
  PluginSearchQuery: 'marketplace.md',
  PluginUpdate: 'marketplace.md',
  ConnectorDescriptor: 'connector.md',
  ConnectorEnrollmentId: 'connector.md',
  ConnectorId: 'connector.md',
  ConnectorLink: 'connector.md',
  ConnectorOpener: 'connector.md',
  ConnectorOs: 'connector.md',

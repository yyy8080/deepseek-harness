...
| [instance.md](instance.md) | isolated runtime instances: branded `InstanceId`s, the lifecycle and `InstanceView`, the `InstanceProvider` protocol, gateway placement |

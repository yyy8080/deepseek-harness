...
Requires: `agentDefaultModel` · `agents` · `attachments` · `directoryPicker` · `instances` · `llm` · `sessions` · `subagents` · `sessionQuery` · `tools` · `userQuestions` · `workspaceRegistry`
...
Source: [`packages/instance/instance-gateway/src/index.ts:61`](../packages/instance/instance-gateway/src/index.ts)

<a id="deepseek-aidsh-instance-local-process"></a>

## `@deepseek-ai/dsh-instance-local-process`

Requires: `instances` · `subprocess`
...
Source: [`packages/instance/instance-local-process/src/index.ts:45`](../packages/instance/instance-local-process/src/index.ts)
...
Source: [`packages/bundle/worker/src/index.ts:36`](../packages/bundle/worker/src/index.ts)

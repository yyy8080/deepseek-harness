...
Source: [`packages/connector/connector/src/index.ts:68`](../packages/connector/connector/src/index.ts)
...
Depends on: [`ConnectorOs`](subsystems/connector.md)

Source: [`packages/connector/connector-tcp/src/index.ts:52`](../packages/connector/connector-tcp/src/index.ts)
...
Source: [`packages/host/connector-portal/src/index.ts:84`](../packages/host/connector-portal/src/index.ts)
...
Depends on: [`ConfigurationPlaneScope`](../packages/client/connection/src/index.ts)
...
- `@deepseek-ai/dsh-fs-connector` — requires `connectors` ([`packages/connector/fs-connector/src/index.ts`](../packages/connector/fs-connector/src/index.ts))
...
- `@deepseek-ai/dsh-subprocess-connector` — requires `connectors` ([`packages/connector/subprocess-connector/src/index.ts`](../packages/connector/subprocess-connector/src/index.ts))

...
export const zh = {
  ...
  'hero.connectorChip': '{connector} · {folder}',
  'hero.connectorWorkspace': '本对话在已连接的机器上运行，工作目录属于该机器',
...
export const en = {
  ...
  'hero.connectorChip': '{connector} · {folder}',
  'hero.connectorWorkspace': 'This conversation runs on a connected machine; the directory belongs to that machine',
